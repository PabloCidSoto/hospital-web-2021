    ...
    <div class="table-responsive pt-2">
        <table class="table table-dark table-striped align-middle">
            ...
            <?php foreach ($datos as $key => $dato) : ?>
                <tr>
                    <td><?= $dato['id_permiso'] ?></td>
                    <td><?= $dato['permiso'] ?></td>                    
                    <td>
                        <div class="d-flex justify-content-between">
                            <a href="permiso.php?action=delete&id_permiso=<?= $dato['id_permiso'] ?>" class="btn btn-outline-danger">
                            ...
                            <a href="permiso.php?action=show&id_permiso=<?= $dato['id_permiso'] ?>" class="btn btn-outline-success">
                                <svg height="12pt" viewBox="0 0 512 512" width="12pt" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="permiso.php?action=show&id_permiso=<?= $dato['id_permiso'] ?>" class="btn btn-outline-secondary">
                                <svg height="12pt" viewBox="0 0 512 512" width="12pt" xmlns="http://www.w3.org/2000/svg">
