        ...
        <table class="table table-dark table-striped align-middle">
            ...
            <?php foreach ($datos as $key => $dato) : ?>
                <tr>
                    ...
                    <td><img src="<?php echo (isset($dato['fotografia']))? 'archivos/'.$dato['fotografia']: 'archivos/default.png'; ?>" alt="foto paciente" class="rounded-circle img-fluid" width="100px"></td>
                    <td><?= $dato['nombre'] ?></td>
                    <td><?= $dato['apaterno'] ?></td>
                    <td><?= $dato['amaterno'] ?></td>
