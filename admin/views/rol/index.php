                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-between">
                            <a href="rol.php?action=delete&id_rol=<?= $dato['id_rol'] ?>" class="btn btn-outline-danger">
                            ...
                            <a href="rol.php?action=show&id_rol=<?= $dato['id_rol'] ?>" class="btn btn-outline-success">
                                <svg height="12pt" viewBox="0 0 512 512" width="12pt" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="rol.php?action=show&id_rol=<?= $dato['id_rol'] ?>" class="btn btn-outline-secondary">
                                <svg height="12pt" viewBox="0 0 512 512" width="12pt" xmlns="http://www.w3.org/2000/svg">
