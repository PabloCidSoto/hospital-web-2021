<h1>Lista de Doctores</h1>
    ...
    <?php endif; ?>
    <a href="doctor.php?action=create" class="btn btn-success">Nuevo Doctor</a>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-between">
                            <a href="doctor.php?action=delete&id_doctor=<?= $dato['id_doctor'] ?>" class="btn btn-outline-danger">
                            ...
                            <a href="doctor.php?action=show&id_doctor=<?= $dato['id_doctor'] ?>" class="btn btn-outline-success">
                                <svg height="12pt" viewBox="0 0 512 512" width="12pt" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="doctor.php?action=show&id_doctor=<?= $dato['id_doctor'] ?>" class="btn btn-outline-secondary">
                                <svg height="12pt" viewBox="0 0 512 512" width="12pt" xmlns="http://www.w3.org/2000/svg">
